...
const env = { ...process.env, DEEPSEEK_SNAPSHOT_MAX_TOKENS: process.env.DEEPSEEK_SNAPSHOT_MAX_TOKENS || '4000', TIMELINE_EVAL_PASSWORD: 'evaluation-only' };
...
const fetcher = async (url, options) => {
  if (url === 'https://api.deepseek.com/chat/completions') return fetch(url, options);
