...
现有项目群聊、侧栏、项目与成员管理交互继续保留，项目记录仍在页面内存。文本 Agent 已真实调用模型，自由对话生成快照已通过本地纵向测试。P1 的 dummy 文件包继续用于协议和隔离回归；目前没有 Timeline 真实业务取数、公司 OAuth、生产项目授权或缓存服务。详见 docs/STATUS.md。
...
生产首发顺序和退出条件见 `docs/PRODUCTION_RELEASE_PLAN_2026-09-12.md`。
